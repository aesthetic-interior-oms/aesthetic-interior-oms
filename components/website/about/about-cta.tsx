  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        <div
          ref={contentRef}
          className="duration-1000 bg-[#a57c00] rounded-3xl p-8 sm:p-12 lg:p-16 text-center relative overflow-hidden"
        >
          {/* Background Pattern */}
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white text-[#a57c00] hover:bg-white/10 rounded-full px-8 bg-transparent"
              >
                View Our Portfolio
              </Button>
            </div>
