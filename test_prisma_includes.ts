...
async function main() {
  ...
  } catch(e: any) { console.error("Include recordedBy failed:", e.message); }
  ...
  } catch(e: any) { console.error("Include financeAccount failed:", e.message); }
  ...
  } catch(e: any) { console.error("groupBy failed:", e.message); }
