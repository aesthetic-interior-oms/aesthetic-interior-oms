...
import { MapPin, Clock, Calendar, CheckCircle2, AlertCircle, Search, History, TrendingUp, CalendarDays, Users, Ban, Target } from 'lucide-react'
...
type VisitDatePreset = 'TODAY' | 'PREVIOUS_DAY' | 'THIS_MONTH' | 'LAST_7_DAYS' | 'LAST_MONTH' | 'LIFETIME' | 'CUSTOM'
  ...
  return (
    <div className="min-h-screen bg-background">
      <CrmPageHeader
        ...
        subtitle="Lifetime record of your visits, outcomes, and lead activity."
      />
          ...
          <PopoverContent align="start" className="w-[320px]">
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {(['TODAY', 'PREVIOUS_DAY', 'THIS_MONTH', 'LAST_7_DAYS', 'LAST_MONTH', 'LIFETIME'] as VisitDatePreset[]).map((preset) => (
                  <Button
                    key={preset}
                    type="button"
                    size="sm"
          ...
          <Card>
            ...
            <CardContent>
              ...
              {recentHistory.length === 0 ? (
                <p className="text-sm text-muted-foreground">No past visits found for the selected filters.</p>
              ) : null}
            </CardContent>
          </Card>
        </TabsContent>
          ...
          {upcomingVisits.length === 0 ? (
            <Card>
              <CardContent className="p-6 text-sm text-muted-foreground">
                No upcoming visits for the current filters.
              </CardContent>
            </Card>
          ) : null}
        </TabsContent>
